		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Deutscland Ticket",
									"targetURL": "#combmwxssessdtwzdtprototype-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combmwxssessdtwzdtprototype-display": {
								"semanticObject": "combmwxssessdtwzdtprototype",
								"action": "display",
								"description": "Deutscland Ticket",
								"title": "Deutscland Ticket",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bmw.xss.ess.dt.wzdtprototype",
									"url": sap.ui.require.toUrl("com/bmw/xss/ess/dt/wzdtprototype")
								}
							}
						}
					}
